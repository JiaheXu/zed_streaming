...
def main():
    ...
    for point in data:
        ...
        # rgb = rgb/255.0
        depth = point['depth'].astype(np.uint16)
        # depth = depth/1000.0
        ...
        pcd = o3d.geometry.PointCloud.create_from_rgbd_image(rgbd, intrinsic=o3d_intrinsic, extrinsic=cam_extrinsic, project_valid_depth_only=True)
        visualize_pcd( pcd )
